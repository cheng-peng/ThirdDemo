...
/**
 * 文 件 名: CircleChart02View
 * 创 建 人: CXP
 * 创建日期: 2017-02-06 15:03
 * 描    述: 图形图例子
 * 修 改 人:
 * 修改时间：
 * 修改备注：
...
//            chart.showRoundBorder();
            //外环
            chart.setORadius(0.8f);
            //内环
            chart.setIRadius(0.8f);

            //百分数字体
            chart.getLabelPaint().setTextSize(66);
            //描述字体
            chart.getDataInfoPaint().setTextSize(66);
